...
<div id="contents">
  ...
  <li class="nav-item">
    <a class="nav-link active" id="messages-tab" href="${pageContext.request.contextPath}/tipsterpersonal/profile" role="tab" aria-controls="messages" aria-selected="true">Profile</a>
  </li>
</ul>
...
<div class="tab-content">
  ...
  <img class="img-rounded" style="width:80px;height:80px" src="${pageContext.request.contextPath}/images/tipsters/${sessionScope.tipster_name}.jpg" onerror="this.onerror=null;this.src='${pageContext.request.contextPath}/images/tipsters/${sessionScope.tipster_name}.png'"/>
