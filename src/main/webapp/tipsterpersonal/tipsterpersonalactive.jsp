...
<div id="contents">
 ...
 <ul class="nav nav-tabs" id="myTab" role="tablist">
  <li class="nav-item">
    <a class="nav-link active" id="home-tab" href="/tipsterpersonal/activetips" role="tab" aria-controls="home" aria-selected="true">Today's Tips</a>
  </li>
  <li class="nav-item">
  ...
  <li class="nav-item">
    <a class="nav-link" id="messages-tab" href="/tipsterpersonal/profile" role="tab" aria-controls="messages" aria-selected="false">Profile</a>
  </li>
</ul>
...
<a class="text-primary" style="text-decoration:underline" href="/tipster/tips?page=1&name=${sessionScope.tipster_name}">See all tips</a>
</div>
