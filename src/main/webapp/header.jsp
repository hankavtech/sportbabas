         ...
         <div class="dropdown mr-5" id="tipstersdiv">
           ...
           <c:if test="${sessionScope.user_type =='tipster'}">
		       <div class="row offset-xs-0 offset-md-5 justify-content-around">
                   ...
                   <div class="col-xs-4">
                   <img style="width:40px;height:40px" src="${pageContext.request.contextPath}/users/${sessionScope.username}.jpg" onerror="this.onerror=null;this.src='${pageContext.request.contextPath}/user.svg'"/>
              ...
              <c:forEach items="${sessionScope.tipstersmap}" var="profile">
               <c:if test="${sessionScope.tipster_name != profile.key}">
                  ...
                  <img style="width:20px;height:20px" class="rounded-circle" src="${pageContext.request.contextPath}/images/sport/${profile.value}.svg" onerror="this.onerror=null;this.src='${pageContext.request.contextPath}/images/sport/${profile.value}.png'"/>
                   ...
                   <div class="col-xs-4">
                   <img style="width:40px;height:40px" src="${pageContext.request.contextPath}/tipsters/${profile.key}.jpg" onerror="this.onerror=null;this.src='${pageContext.request.contextPath}/tipsters/${profile.key}.png'"/>
                   <p><c:out value="${profile.key}"/></p>
