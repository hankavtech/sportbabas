...
<div class="container mt-5">
	 ...
	 <div class="row bg-dark mb-3">
	    <div id="imagediv" class="col-xs-12 text-center col-sm-6 col-md-4">
		    ...
		    <img class="image-fluid rounded-circle mb-2" style="width:100px;height:100px" src="${pageContext.request.contextPath}/images/tipsters/${requestScope.tipstername}.jpg" onerror="this.onerror=null;this.src='${pageContext.request.contextPath}/images/tipsters/${requestScope.tipstername}.png'" />
		    <div></div>
...
<c:forEach items="${requestScope.firstpagelist[2]}" var="item1">
	<tr><td><img src='${pageContext.request.contextPath}/${initParam["sport"]}/${item1[6]}.svg' style='width:20px;height:20px'/></td><td><a class='text-warning' href='/tip?id=${item1[0]}'>${item1[1]} vs ${item1[2]}</a></td>
