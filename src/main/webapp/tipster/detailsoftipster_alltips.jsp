...
<div class="container mt-5">
	 ...
	 <div class="row bg-dark mb-3">
	    ...
	    <img class="image-fluid rounded-circle mb-2" style="width:100px;height:100px" src="${pageContext.request.contextPath}/images/tipsters/${requestScope.topstats[0][3]}.jpg" onerror="this.onerror=null;this.src='${pageContext.request.contextPath}/images/tipsters/${requestScope.topstats[0][3]}.png'" />
	    <div></div>
		...
		$.ajax({
			...
			success:function(response){
				...
				if(response==="error"){
					...
					$("#cartitems").append("<div class='row justify-content-between'><div class='col-xs-4'><img style='width:30px;height:30px' class='image-fluid rounded-circle mb-2' src='${pageContext.request.contextPath}/images/tipsters/"+res.name+".jpg'/><p class='text-nowrap text-left'>"+res.name+"</p></div><div class='col-xs-2'><p><b>"+res.months+" month subscription</b></p></div><div class='col-xs-2'><span><b>"+parseFloat(convcurrency*parseInt(res.months)).toFixed(2)+"</b> </span> <img style='width:20px;height:20px' src='${pageContext.request.contextPath}/images/css/currency/"+currency+".svg'/><button type='button' id='removesubscription' class='close' aria-label='Close'><span style='color:red;' aria-hidden='true'>&times;</span></button></div></div>");
