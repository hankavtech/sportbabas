...
<div class="container mt-5">
  ...
  <li class="nav-item">
    <a class="nav-link active" id="messages-tab" href="${pageContext.request.contextPath}/Profile" role="tab" aria-controls="messages" aria-selected="true">Profile</a>
  </li>
  <li class="disabled">
...
<div class="tab-content">
  ...
  <img style="width:40px;height:40px" src="${pageContext.request.contextPath}/images/users/${sessionScope.username}.jpg" onerror="this.onerror=null;this.src='${pageContext.request.contextPath}/images/users/${sessionScope.username}.png'"/>
...
$("#subpreferences").on("click",function(e){
	...
	console.log(timezone);
	 $.ajax({
		 method:"POST",
		 url:"${pageContext.request.contextPath}/ChangePreferences",
