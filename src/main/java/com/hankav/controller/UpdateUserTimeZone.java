...
/**
 * Servlet implementation class UpdateUserTimeZone
 */
@WebServlet("/UpdateUserTimeZone")
public class UpdateUserTimeZone extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		user.setUser_preferences(new Preferences(pref.getOddsformat(),timezone,pref.getCurrency()));
		session.update(user);
